...
?>
			...
			<div class="modal fade" id="modal_lokasi" role="dialog">
				<div class="modal-dialog">
					<div class="modal-content">
						...
						<div class="modal-body" style="overflow: hidden;">
							<form id="modal_loc" class="form-horizontal">
							<div class="col-sm-12" id="lokasi">
								<input type="hidden" name="id_pt" value="<?=$_GET['id'];?>">
								<div class="col-sm-11 lokasi-input">
									<?php 
						...
						<div class="modal-footer">
							<button type="button" id="tambah_loc" class="btn btn-primary pull-right">Tambahkan</button>
						</div>
						<script type="text/javascript">
							$("#tambah_loc").click(function(){
								$.ajax({
									url: 'add_loc.php',
									type: 'post',
									data: $("#modal_loc").serialize(),
	...
	<div class="col-sm-offset-2 col-sm-10 content">
		<div class="col-sm-offset-1 col-sm-10 konten">
			...
			<form class="form-horizontal" method="post" action="<?=base_url();?>/admin/edit_proc.php?id=<?=$id;?>">
				<div class="col-sm-7">
				...
				<div class="col-sm-12">
					...
					<div class="col-sm-6 lokasi-input">
						...
						<div class="form-group">
							<label class="control-label col-sm-4">Provinsi</label>
							<div class="col-sm-8">
								<select name="provinsi" id="prov2" class="form-control">
									<option>-</option>
						...
						<div class="form-group">
							<label class="control-label col-sm-4">Kota/Kabupaten</label>
							<div class="col-sm-8">
								<select name="kota" class="form-control" id="kota2">
									<option>-</option>
					...
					<?php else:?>
						...
						<button id="modal_lokasi" class="btn btn-info" type="button" data-toggle="modal" role="dialog" data-target="#modal_lokasi">Tambah lokasi</button>
					...
					<div class="modal-content">
						...
						<script type="text/javascript">
							...
							$("#prov2").change(function(){
								var prov = $("select#prov2 option:selected").val();
								$.ajax({
									url: '../kota.php',
									type: 'post',
									data: 'prov='+prov,
