...
?>
	...
	<div class="col-sm-offset-2 col-sm-10 content">
		<div class="col-sm-offset-1 col-sm-10 konten">
			<div class="title"><h4>Tambah data baru</h4></div>
			<form class="form-horizontal" action="<?=base_url()?>/admin/add_proc" method="post">
				<div class="col-sm-7">
					...
					<div class="form-group">
						...
						<div class="col-sm-7">
							<input type="text" class="form-control" id="website" name="web" required>
						</div>
					</div>
					<div class="form-group">
						<label class="control-label col-sm-5" for="no_telp">No. Telpon</label>
						<div class="col-sm-7">
							<input type="text" class="form-control" id="no_telp" name="telpon" required>
						</div>
					</div>
					<div class="form-group">
				...
				<div class="col-sm-12" id="lokasi">
					<div>
						<h5>Lokasi  &nbsp;
							<button type="button" id="tbl" class="btn btn-xs btn-primary"><span class="glyphicon glyphicon-plus" title="Tambah form lokasi"></button>
						</h5>
					</div><hr>
				...
				<div class="col-sm-6 pull-right save-button">
					<button id="tambahken" class="btn btn-primary"><span class="glyphicon"></span> Tambahkan data</button>
				</div>
			</form>
		</div>
	</div>
